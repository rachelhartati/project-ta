            ...
            <div class="content">
                ...
                <div class="table-box">
                    ...
                    <div class="table-header">
                        ...
                        <div class="header-action">
                            ...
                            <div class="search-box">
                                <input type="text" placeholder="Cari nama agen...">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action">
                                        ...
                                        <a href="{{route('agent.detail', $agen->id)}}" class="btn btn-view">
                                            Detail
                                        </a>

                                        <a href="{{route('agent.edit', $agen->id)}}" class="btn btn-edit">
                                            Edit
                                        </a>
                    ...
                    <div class="pagination">
                        ...
                        <span>
                            Menampilkan {{ $agent->count() }} dari {{ $agent->total() }} agent
                        </span>
